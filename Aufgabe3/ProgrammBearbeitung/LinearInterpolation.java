...
public class LinearInterpolation implements InterpolationMethod {
     ...
     * und ordnet die Stuetzstellen der Groesse nach. Die Faelle "x und y sind
     * unterschiedlich lang" oder "eines der beiden Arrays ist leer" werden
     * nicht beachtet.
     *
    ...
    public double evaluate(double z) {
        ...
        // Behandlung der aeussersten Werte
        if (z < x[0]) {
            return y[0];
        ...
        //Suche nach der naheliegensten Stuetzstelle
        int index = 0;
        ...
        double steigung = (y[index + 1] - y[index]) / (x[index + 1] - x[index]);
        
        double verschiebung = y[index] - (steigung * x[index]);
        
        result = steigung * z + verschiebung;
